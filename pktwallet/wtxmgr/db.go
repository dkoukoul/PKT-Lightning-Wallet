...
func appendRawBlockRecord(v []byte, txHash *chainhash.Hash) ([]byte, er.R) {
	if len(v) < 44 {
...
func putRawBlockRecord(ns walletdb.ReadWriteBucket, k, v []byte) er.R {
...
func valueTxRecord(rec *TxRecord) ([]byte, er.R) {
	var v []byte
...
func readRawTxRecord(txHash *chainhash.Hash, v []byte, rec *TxRecord) er.R {
	if len(v) < 8 {
		str := fmt.Sprintf("%s: short read (expected %d bytes, read %d)",
...
func fetchRawTxRecordPkScript(k, v []byte, index uint32) ([]byte, er.R) {
	var rec TxRecord
...
func putRawCredit(ns walletdb.ReadWriteBucket, k, v []byte) er.R {
...
func fetchRawCreditAmount(v []byte) (btcutil.Amount, er.R) {
	if len(v) < 9 {
		str := fmt.Sprintf("%s: short read (expected %d bytes, read %d)",
...
func fetchRawCreditAmountChange(v []byte) (btcutil.Amount, bool, er.R) {
	if len(v) < 9 {
		str := fmt.Sprintf("%s: short read (expected %d bytes, read %d)",
			bucketCredits, 9, len(v))
...
func fetchRawCreditUnspentValue(k []byte) ([]byte, er.R) {
	if len(k) < 72 {
		str := fmt.Sprintf("%s: short key (expected %d bytes, read %d)",
...
// amount is returned.
func spendCredit(ns walletdb.ReadWriteBucket, k []byte, spender *indexedIncidence) (btcutil.Amount, er.R) {
...
func unspendRawCredit(ns walletdb.ReadWriteBucket, k []byte) (btcutil.Amount, er.R) {
...
func deleteRawCredit(ns walletdb.ReadWriteBucket, k []byte) er.R {
...
func (it *creditIterator) readElem() er.R {
	if len(it.ck) < 72 {
		str := fmt.Sprintf("%s: short key (expected %d bytes, read %d)",
...
func deleteRawDebit(ns walletdb.ReadWriteBucket, k []byte) er.R {
...
func (it *debitIterator) readElem() er.R {
	if len(it.ck) < 72 {
		str := fmt.Sprintf("%s: short key (expected %d bytes, read %d)",
...
func putRawUnmined(ns walletdb.ReadWriteBucket, k, v []byte) er.R {
...
func readRawUnminedHash(k []byte, txHash *chainhash.Hash) er.R {
	if len(k) < 32 {
...
func deleteRawUnmined(ns walletdb.ReadWriteBucket, k []byte) er.R {
...
func putRawUnminedCredit(ns walletdb.ReadWriteBucket, k, v []byte) er.R {
...
func fetchRawUnminedCreditIndex(k []byte) (uint32, er.R) {
	if len(k) < 36 {
...
func deleteRawUnminedCredit(ns walletdb.ReadWriteBucket, k []byte) er.R {
...
func (it *unminedCreditIterator) readElem() er.R {
...
// spent.
func putRawUnminedInput(ns walletdb.ReadWriteBucket, k, v []byte) er.R {
...
func createStore(ns walletdb.ReadWriteBucket) er.R {
...
// number.
func putVersion(ns walletdb.ReadWriteBucket, version uint32) er.R {
	var v [4]byte
...
func fetchVersion(ns walletdb.ReadBucket) (uint32, er.R) {
